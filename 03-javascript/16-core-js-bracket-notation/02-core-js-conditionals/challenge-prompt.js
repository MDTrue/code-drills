...
var characterOneYearlySavings = characterOneSalary - (characterOneYearlyExpenses + characterOneYearlyRent);
...
else {console.log(characterTwoName + " is older");}
...
if(characterOneYearlySavings > characterTwoYearlySavings) {
 ...
 else {console.log(characterTwoName + " is a high roller!");}   
