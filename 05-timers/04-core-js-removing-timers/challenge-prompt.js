...
var four = setTimeout(log("hello"),17000);
...
var five = setTimeout(log("Goodbye"),17000);
...
function removeFive(){
  return clearTimeout(five)
}
setTimeout(removeFive,5000)

console.log("==================== Question 04 ====================");
// create a timer that logs "Part 1" after 3 seconds
var six  = setTimeout(log("part 1"),3000);
...
function removeSix(){
  console.log("part 2")
  return clearTimeout(six)
}
var seven = setTimeout(removeSix, 20000);
...
function removeSeven(){
  console.log("part 3")
  return clearTimeout(seven)
}
var eight = setTimeout(removeSeven,1000)
