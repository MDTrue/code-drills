...
$(document).ready(function () {
  ...
  var body = $("body")
  // 1.3 create a variable called btns and assign the result of calling the "find" method on the body variable to find the
  //  element with an id of "buttons"
 var btns = body.find("#buttons");
  ...
  for (var j = 0; j < letters.length; j++) {
    ...
    textButton.attr("data-letter", letters[j]);

    // 2.5. now give "textButton" a text of each index of letters.
    textButton.text(letters[j]);
  ...
  btns.on("click", ".letter-button", function () {
    ...
    // 3.4 use the var textDiv and add text that is equal to the this or button that creates the letter and add a attribute of a
    //  string data-letter 
    textDiv.attr($(this).attr("data-letter"));
