...
// What is the value of `tracked` here?----"We're"
...
function loseTracked3(tracked) {
  ...
  // What is the value of `tracked` here?
  // We're no undefined we are inside an uncalled function
  // console.log(tracked)
}
...
// What is the value of `tracked` here?
// "love" notice tracked is not defined as a var inside the function
...
function loseTracked6(arg) {
  ...
  // What is the value of `tracked` here?
  // undefined  no  loseTracked6 doesn't do anything so it stays love
  // console.log(tracked)
}
...
// What is the value of `tracked` here?
// and  no the.   it stays where it is absolutely defined we are not inside the function
// console.log(tracked)
...
// What is the value of `tracked` here?
// so  no still the  functoin losetracked9is not called
...
// What is the value of `tracked` here?
// a: "hello", b: "world"  more or less correct  it is the object containing these
// console.log(tracked)
...
// What is the value of `tracked` here?
// ["variable", "scoping", "is"] more correctly the array
...
function loseTracked15(arg) {
  ...
  // What is the value of `tracked` here?
  //  What!? Arrays!  or  more correctly the array containing these
  // console.log(tracked)
}
...
function loseTracked16(arg) {
  ...
  // What is the value of `tracked` here?
  // {how: "about", objects: "?"} No it is the object inside the function
  // console.log(tracked)
}
...
function loseTracked17(arg) {
  ...
  // What is the value of `tracked` here?
  // the array containing "R","ick" no tracked is not a variable so it is never...up
  // console.log(tracked)
}
